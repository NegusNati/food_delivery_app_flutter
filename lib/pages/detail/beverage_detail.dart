...
class BeverageDetail extends StatelessWidget {
  int pageId;
  BeverageDetail({
    Key? key,
  ...
  Widget build(BuildContext context) {
    ...
    var product =
        Get.find<BeverageController>().popularProductList[pageId];
    ...
    return Scaffold(
          ...
          Positioned(
            ...
            child: Row(
                ...
                children: [
                  ...
                  // the cart icon
                  GetBuilder<BeverageController>(builder: (product) {
                    return GestureDetector(
                      ...
                      child: Stack(
                        children: [
                          ...
                          Get.find<BeverageController>().totalItems >= 1
                              ? Positioned(
                                  right: 0,
                                  top: 0,
                                  child: AppIcon(
                          ...
                          Positioned(
                              ...
                              top: 2,
                              child: BigText(
                                text: Get.find<BeverageController>()
                                    .totalItems
                                    .toString(),
                                color: Colors.white,
                                size: 14,
      ...
      bottomNavigationBar:
          GetBuilder<BeverageController>(builder: (popularProduct) {
        return Container(
